...
namespace ejercicio_7
{
    class Program
    {
        ...
        private static double buscarelementos(string[] algebra, string[] analisis, string[] comunes, int v)
        {
            throw new NotImplementedException();
        }

        private static void rellenararreglo(string[] algebra, int v1, string v2)
        {
            throw new NotImplementedException();
        }
